...
## Profile homepage link (recruiter-friendly)
To keep your profile homepage organized, add a short **CTF Case Studies** section and place the entry below your **RDP compromise CTF** item. Use the snippet below as-is:

```markdown
### CTF Case Studies
- [RDP compromise CTF](<YOUR-RDP-CTF-URL>)
- [CorpHealth Operations Activity Review (Microsoft Defender Advanced Hunting CTF)](https://github.com/CARLOSFUN/corphealth-traceback-threat-hunt)
  - Investigation report, timeline, IOCs, detections, and reproducible KQL queries
```
